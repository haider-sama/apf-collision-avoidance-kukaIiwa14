...
for cfg = 1:2
    ...
    for i = 1:iterations
        ...
        % B. Repulsive Force
        % (summed over all collision links and obstacles)
        ...
        for L = 1:length(collision_links)
            ...
            for j = 1:size(obs, 1)
                ...
                rho = dist_to_center - obs_r;

                % Distance to obstacle surface
                if rho <= rho_0 && rho > 0.001

                    % Formula:
                    % k_rep * (1/rho - 1/rho_0) * (1/rho^2) * unit_direction

                    rep_mag = k_rep * ...
                        (1/rho - 1/rho_0) * ...
                        (1/rho^2);

                    F_rep_total = F_rep_total + ...
                        (rep_mag * (dist_vec / dist_to_center));
        ...
        if i > 15
            ...
            net_displacement = norm( ...
                x_ee' - pos_buffer(:, mod(i-14,15)+1));

            if net_displacement < 0.01
                % Trapped if moved < 1cm in 15 steps
    ...
    exportgraphics( ...
        fig_robot, ...
        sprintf('screenshots/robot_config%d.png', cfg), ...
        'Resolution', 150);
    ...
    plot3( ...
        trace_x(find(valid,1)), ...
        trace_y(find(valid,1)), ...
        trace_z(find(valid,1)), ...
        'go', ...
        'MarkerSize', 10, ...
        'LineWidth', 2);
    ...
    exportgraphics( ...
        fig_traj, ...
        sprintf('screenshots/traj_config%d.png', cfg), ...
        'Resolution', 150);
    ...
    title(sprintf('Joint Velocity Profiles — %s', ...
        config_names{cfg}));
    ...
    exportgraphics( ...
        fig_vel, ...
        sprintf('screenshots/jointvel_config%d.png', cfg), ...
        'Resolution', 150);

    %% PLOT 3 — Potential Field Landscape
    % (2D slice at z = goal_z)
    ...
    title(sprintf( ...
        'APF Potential Landscape (z=%.2f m) — %s', ...
        z_slice, config_names{cfg}));
    ...
    exportgraphics( ...
        fig_pot, ...
        sprintf('screenshots/potential_config%d.png', cfg), ...
        'Resolution', 150);
...
exportgraphics( ...
    fig_cmp, ...
    'screenshots/velocity_comparison.png', ...
    'Resolution', 150);
